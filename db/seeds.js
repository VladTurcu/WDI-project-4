...
User.create([{
  ...
  image: 'https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/14322479_10206990009537311_739998228969557179_n.jpg?oh=4883373bd1785aaf960da47f1fde495a&oe=5AA59AAB',
  achievements: [],
  admin: true,
...
.then((users) => {
  console.log(`${users.length} products created!`);
  ...
  .then(courses => console.log(`${courses.length} products created!`));
})
