...
const courseData = [{
  ...
  stages: {
    ...
    test: [{
      ...
      answer: 'From both white and red',
      options: ['From only white grapes', 'From only red grapes', 'From only pink grapes']
    }, {
      stage: 3,
      question: 'How would you describe a dry wine?',
      answer: 'A wine that has no traces of sweetnes',
      options: ['A wine that leaves your muth dry', 'A wine that has high levelsof alcohol', 'A wine that is sweet']
    }]
  }
}];
